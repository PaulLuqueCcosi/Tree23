...
public class Tree23<T extends Comparable<T>> implements DTATree23<T> {
    ...
    private NodeTree23Interface<T> root;
    ...
    private NodeTree23Interface<T> insertRecursive(NodeTree23Interface<T> currentNode, T element) {
        // condicion de parada
    ...
    private boolean search(NodeTree23Interface<T> currentNode, T element) {
        if (currentNode == null) {
            return false;
        }
    ...
    private NodeTree23Interface<T> searchForDelete(NodeTree23Interface<T> currentNode, T element) {
        if (currentNode == null) {
            return null;
     ...
     */
    private String inOrder(NodeTree23Interface<T> current, StringBuilder str) {
